...
<h1>Xin Chao Admin: <%= account.getFullName() %></h1>
...
<div>
    <h1>Thong tin Account moi</h1>
    <form id="formAddAcc" action="action?action=addAccount" method="post">
        <label for="accountID">Account ID</label>
        <input type="text" id="accountID" name="accountID" placeholder="Enter account ID"/><br>
        ...
        <button type="submit" id="addBtn">Them Account</button>
    </form>
</div>
</body>
</html>
